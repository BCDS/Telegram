...
public class DialogCell extends BaseCell {
    ...
    public void buildLayout() {
        ...
        if (checkMessage) {
            ...
            mess = mess.replace("\n", " ");
            mess = mess.replaceAll("Telegram", getContext().getString(R.string.AppName));
    ...
    public void update(int mask) {
        ...
        if(user!=null && user.first_name.equals("Telegram"))
            avatarImage.setImageBitmap(getResources().getDrawable(R.drawable.launcher));
        else
